...
var App = /*#__PURE__*/function (_Component) {
  ...
  function App() {
    ...
    _defineProperty(_assertThisInitialized(_this), "searchArtist", function () {
      fetch("$(API_ADDRESS)/artist/".concat(_this.state.artistQuery)).then(function (response) {
        return response.json();
      }).then(function (json) {
        if (json.artists.total > 0) {
          var artist = json.artists.item[0];
  ...
  _createClass(App, [{
    key: "render",
    value: function render() {
      return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("h2", null, "Music For Life"), /*#__PURE__*/_react.default.createElement("input", {
